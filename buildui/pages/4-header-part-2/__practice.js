  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-1 text-slate-600">
      <div className="z-0 flex-1">
        <motion.header
          style={{
            height: useTransform(scrollYBoundedProgressThrottled, [0, 1], [72, 50]),
          ...
          className="fixed inset-x-0 flex h-[4.5rem] bg-white/10 shadow backdrop-blur-md"
        >
          <div className="mx-auto flex w-full max-w-3xl items-center justify-between px-8">
            <motion.p
              style={{ scale: useTransform(scrollYBoundedProgressThrottled, [0, 1], [1, 0.85]) }}
